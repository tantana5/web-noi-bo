...
class UserRepository extends Repository {
    ...
    public function store() {
        ...
        if ($obj) {
            return redirect()->action('UserController@index')->with('status', true)->with('message', 'Thêm mới thành công!');
        }
    ...
    public function update($id) {
        ...
        if (!$obj) {
            return redirect()->action('UserController@index')->with('error', true)->with('message', 'Cập nhật thất bại!');
        }
        return redirect()->action('UserController@index')->with('status', true)->with('message', 'Cập nhật thành công!');
    }
    ...
    public function destroy($id) {
        ...
        $user->delete();
        if (!$user) {
            return redirect()->action('UserController@index')->with('error', true)->with('message', 'Xóa thất bại!');
        }
        return redirect()->action('UserController@index')->with('status', true)->with('message', 'Xóa thành công!');
    }
    ...
    public function postPurchase() {
        ...
        return redirect()->action('UserController@index')->with('message', 'Nạp tiền thành công');
    }
